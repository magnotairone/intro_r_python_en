...
When you are exploring different types of plots to visualize your data, the site [Data to Viz](https://www.data-to-viz.com) can be a valuable tool. It provides a complete gallery of plot types and offers guidance on when and how to use each one. Additionally, the site provides specific examples of how to create these plots using different libraries, such as ggplot2 in R and matplotlib in Python.
...
**3. (Challenge)** Reproduce the scatter plot presented in @sec-fluxos-funcoes.
