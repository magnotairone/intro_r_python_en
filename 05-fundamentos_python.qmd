...
In the code above, we create a variable called `country` and assign it the value "Brazil", which is a `string`. Then, we print the value of the variable country using `print(country)`, which displays "Brazil" on the screen. Finally, we check the data type of the variable country with `type(country)`, which returns `<class 'str'>`, indicating that it is a string.
...
# Creating a list of datas
datas = pd.data_range(start='2023-01-01', end='2023-12-31', freq='B')  # Frequency 'B' to consider only business days
...
df_share_prices = pd.dataFrame({'data': datas, 'Closing Price': closing_prices})
...
df_share_prices['Day of the Week'] = df_share_prices['data'].dt.weekday
