...
data = {'Name': ['João', 'Maria', 'Pedro', 'Ana', 'Mariana'],
...
-   The missing values in the "Age" column were filled with the median of the existing ages in the DataFrame.
-   The missing values in the "Credit Limit" column were filled with the mode of the existing credit limits in the DataFrame.
-   The missing values in the "Monthly Income" column were filled with the mean of the existing monthly incomes in the DataFrame.
